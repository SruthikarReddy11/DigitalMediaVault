"use strict";(()=>{var r="vaultxmedia-floating-save-btn",i="vaultxmedia-save-toast";function u(){let t=window.location.href.toLowerCase(),a=window.location.hostname.toLowerCase();if(a.includes("amazon."))return t.includes("/dp/")||t.includes("/gp/product/")||t.includes("/d/");if(a.includes("flipkart.com"))return t.includes("/p/")||t.includes("pid=");if(a.includes("myntra.com"))return/\/\d+\/buy/.test(t)||t.includes("/buy");if(a.includes("ajio.com"))return t.includes("/p/");if(a.includes("meesho.com"))return t.includes("/s/p/")||t.includes("/p/");if(a.includes("nykaa.com"))return t.includes("/p/");if(a.includes("tatacliq.com"))return t.includes("/p-");if(a.includes("croma.com")||a.includes("reliancedigital.in"))return t.includes("/p/");let e=document.querySelector('script[type="application/ld+json"]');return e&&e.textContent?.includes('"Product"'),!0}function c(t){let a=document.getElementById(i);a&&a.remove();let e=document.createElement("div");e.id=i,e.className=`vaultx-toast ${t.isError?"vaultx-toast-error":"vaultx-toast-success"}`;let s=t.price!==void 0&&t.price!==null?`${t.currencySymbol||"\u20B9"}${t.price.toLocaleString("en-IN")}`:"",o=t.imageUrl?`<img src="${t.imageUrl}" class="vaultx-toast-img" alt="Product" onerror="this.style.display='none'" />`:`<div class="vaultx-toast-icon-box">${t.isError?"\u2715":"\u2713"}</div>`;e.innerHTML=`
