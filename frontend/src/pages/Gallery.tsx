      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-slate-900 via-slate-900/90 to-pink-950/35 border border-white/[0.08] p-6 sm:p-8 shadow-2xl">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={openUpload}
              className="flex items-center gap-2 px-4.5 py-2.5 bg-gradient-to-r from-pink-600 to-rose-600 hover:from-pink-500 hover:to-rose-500 text-white text-xs sm:text-sm font-bold rounded-xl transition shadow-lg shadow-pink-600/25 border border-pink-400/30 active:scale-95"
            >
