              ...
              >
                <div>
                  ...
                  <div className="relative aspect-square w-full bg-slate-950 flex items-center justify-center p-3 overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-slate-950/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2 p-3 backdrop-blur-[2px]">
                      <button
                        type="button"
                        onClick={(e) => {
                          e.stopPropagation();
                        ...
                        className="px-4 py-2 rounded-xl bg-brand-600 hover:bg-brand-500 text-white text-xs font-bold shadow-lg transition flex items-center gap-1.5"
                      >
                      ...
                      <a
                        ...
                        className="p-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-white transition shadow-lg"
                        title="Buy on Store"
                      >
                ...
                <div className="p-4 pt-2 border-t border-slate-800/80 flex items-center justify-between gap-2">
                  ...
                  <span className="text-[11px] text-brand-400 font-bold group-hover:translate-x-0.5 transition-transform flex items-center gap-1">
                    <span>Details</span>
                    <span>→</span>
                  </span>
                </div>
